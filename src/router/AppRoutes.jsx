...
import DataAgen from "../pages/brilife/DataAgen";
import DataAgenStruktur from "../pages/brilife/DataAgenStruktur";
...
const AppRoutes = () => {
    return (
        <Routes>
            ...
            <Route path="/agenStruktur" element={<DashboardAgen />} />
            ...
            <Route path="/dataAgen" element={<DataAgen />} />
            <Route path="/dataAgenStruktur" element={<DataAgenStruktur />} />
